...
const RULES = [
  ...
  ['Offizieller Shop | Sensor Crash Fix — Code, Puls & Training', 'Uradna trgovina | Sensor Crash Fix — geslo, utrip in vadba'],
  ['Kasse | Sensor Crash Fix — Offizieller Shop', 'Blagajna | Sensor Crash Fix — Uradna trgovina'],
  ['Mein Konto | Sensor Crash Fix', 'Moj račun | Sensor Crash Fix'],
  ['Community (Beta) | Sensor Crash Fix', 'Skupnost (beta) | Sensor Crash Fix'],
  ['Wo kaufen | Sensor Crash Fix — Code- & Pulsmessprobleme', 'Kje kupiti | Sensor Crash Fix — geslo in utrip'],
  ...
  ['<span class="badge">Sensor Crash Fix Linse</span>', '<span class="badge">Leča Sensor Crash Fix</span>'],
