...
const RULES = [
  ...
  ['Smartwatch fragt nach Passcode, misst Puls nicht oder bricht Training ab? | Sensor Crash Fix', 'Pametna ura zahteva geslo, ne meri pulza ali prekine vadbo? | Sensor Crash Fix'],
  ['Die Uhr fragt alle 10 Sekunden nach dem Passcode, misst den Puls nicht, trennt die Verbindung oder bricht das Training ab? cracks-Tinte blockiert oft den Sensor. Sensor Crash Fix Linse — Apple Watch, Samsung, Garmin. 3N20-Technologie.', 'Ura vsakih 10 sekund zahteva geslo, ne meri pulza, prekine povezavo ali vadbo? Tinta tetovaže pogosto blokira senzor. Leča Sensor Crash Fix — Apple Watch, Samsung, Garmin. Tehnologija 3N20.'],
  ['smartwatch fragt nach passcode, uhr passcode alle 10 sekunden, smartwatch ständig passcode, smartwatch pulsmessung funktioniert nicht, herzfrequenz funktioniert nicht, smartwatch misst puls nicht, sensor funktioniert nicht, smartwatch trennt verbindung, uhr verliert handgelenkserkennung, training bricht ab, apple watch passcode cracks, apple watch herzfrequenz cracks, samsung watch sensor, garmin herzfrequenz, smartwatch cracks, handgelenkserkennung cracks, Sensor Crash Fix', 'pametna ura zahteva geslo, ura geslo vsakih 10 sekund, pametna ura nenehno geslo, pametna ura merjenje pulza ne deluje, srčni utrip ne deluje, pametna ura ne meri pulza, senzor ne deluje, pametna ura prekine povezavo, ura izgubi zaznavo zapestja, vadba se prekine, apple watch geslo tetovaža, apple watch srčni utrip tetovaža, samsung watch senzor, garmin srčni utrip, pametna ura tetovaža, zaznava zapestja tetovaža, Sensor Crash Fix'],
  ['Smartwatch: Passcode oder Pulsmessung? | Sensor Crash Fix', 'Pametna ura: geslo ali merjenje pulza? | Sensor Crash Fix'],
  ['Passcode alle 10 Sekunden, Pulsmessung ausgefallen oder Training unterbrochen? Lösung für Smartwatch auf gerissenem Sensor — Apple Watch, Samsung, Garmin.', 'Geslo vsakih 10 sekund, merjenje pulza ne deluje ali prekinjena vadba? Rešitev za pametno uro na počenem tipalu — Apple Watch, Samsung, Garmin.'],
  ['Sensor Crash Fix — Smartwatch auf gerissenem Sensor', 'Sensor Crash Fix — Pametna ura na počenem tipalu'],
  ['Die Uhr fragt ständig nach dem Passcode, misst den Puls nicht oder trennt die Verbindung? cracks-Tinte kann den Sensor blockieren — entdecken Sie Sensor Crash Fix.', 'Ura nenehno zahteva geslo, ne meri pulza ali prekine povezavo? Tinta tetovaže lahko blokira senzor — spoznajte Sensor Crash Fix.'],
  ...
  ['<p><strong>Passcode alle 10 Sekunden</strong>, <strong>Puls wird nicht gemessen</strong>, <strong>Verbindung bricht ab</strong> oder <strong>Training wird unterbrochen</strong>? Auf tätowierten Handgelenken blockiert die Tinte den optischen Sensor. Stellen Sie Handgelenkserkennung, Herzfrequenz und Training auf Apple Watch, Samsung, Garmin und mehr wieder her — mit der Sensor Crash Fix Linse (3N20).</p>', '<p><strong>Geslo vsakih 10 sekund</strong>, <strong>pulz se ne meri</strong>, <strong>povezava se prekine</strong> ali <strong>vadba se prekine</strong>? Na tetoviranih zapestjih tinta blokira optični senzor. Obnovite zaznavo zapestja, srčni utrip in vadbo na Apple Watch, Samsung, Garmin in drugih — z lečo Sensor Crash Fix (3N20).</p>'],
  ...
  ['<p>Das cracks hindert den Sensor daran, die Herzfrequenz korrekt zu messen.</p>', '<p>Tetovaža senzorju preprečuje pravilno merjenje srčnega utripa.</p>'],
  ...
  ['<p class="about-origin"><strong>Sensor Crash Fix</strong> entstand aus einer echten Erfahrung.</p>', '<p class="about-origin"><strong>Sensor Crash Fix</strong> je nastal iz resnične izkušnje.</p>'],
  ['<p class="about-body">Sensor Crash Fix wurde nicht in einem fernen Labor oder mit geheimer Luft- und Raumfahrttechnik entwickelt. Es entstand in Imirim, Nordzone von São Paulo, im „Haus der Oma“ — wo ich geboren wurde und Jahre später, nachdem Oma Maria in den Himmel ging, mein Zuhause machte.</p>', '<p class="about-body">Sensor Crash Fix ni nastal v oddaljenem laboratoriju ali s skrivno vesoljsko tehnologijo. Nastalo je v Imirimu, severni coni São Paula, v «Hiši babice» — kjer sem se rodil in leta pozneje, ko je babica Maria šla v nebesa, to mesto postal moj dom.</p>'],
  ['<p class="about-body">Seit meiner Kindheit bin ich verrückt nach cracks; ich konnte kein schlecht gemachtes Spinnennetz vorbeiziehen sehen, ohne hypnotisiert zu werden, und kaufte jeden Aufkleber am Kiosk. Mit der Zeit wurde ich ein großer Bewunderer und Sammler der cracks-Kunst. Ich füllte meinen Körper mit Tinte und lernte viele Menschen aus der cracks-Welt kennen.</p>', '<p class="about-body">Od otroštva sem bil nor na tetovaže; nisem mogel mimo slabo narejenega pajkovega mreženja brez hipnotiziranja in kupil vsake nalepke na kiosku. Sčasoma sem postal velik oboževalec in zbiralec tetovažne umetnosti. Telo sem napolnil z tinto in spoznal veliko ljudi iz sveta tetovaž.</p>'],
  ...
  ['<p class="about-body"><strong>Da war es — die unvollkommene Mischung: cracks + Smartwatch = Problem.</strong></p>', '<p class="about-body"><strong>In tu je bilo — nepopolna kombinacija: tetovaža + pametna ura = problem.</strong></p>'],
  ...
  ['<p class="about-body">Mit wasserbeständiger Haftung und einer Linse, die Licht perfekt durch die Tinte bricht: voilà! Sensor Crash Fix war geboren.</p>', '<p class="about-body">Z vodoodpornim lepljenjem in lečo, ki svetlobo popolnoma lomi skozi tinto: voilà! Sensor Crash Fix je bil rojen.</p>'],
  ...
  ['<p class="about-body">Heute verkauft <strong>3N20</strong> die Sensor Crash Fix Linse über unseren <strong>offiziellen Shop</strong> — PayPal und Karten, Sendungsverfolgung. Keine Tricks, kein Verlust von Gesundheitsfunktionen — Unterstützung von Menschen, die das Problem auf der Haut erlebt haben. Wörtlich.</p>', '<p class="about-body">Danes <strong>3N20</strong> prodaja lečo Sensor Crash Fix prek naše <strong>uradne trgovine</strong> — PayPal in kartice, sledenje pošiljki. Brez trikov, brez izgube zdravstvenih funkcij — podpora ljudi, ki so problem doživeli na lastni koži. Dobesedno.</p>'],
  ...
  ['<p class="about-closing">Also: von einem Tätowierten zu anderen, die die Kunst ebenfalls bewundern — hier ist die wahre Geschichte von Sensor Crash Fix.</p>', '<p class="about-closing">Torej: od tetoviranega do drugih, ki prav tako občudujejo to umetnost — tu je resnična zgodba Sensor Crash Fix.</p>'],
  ['alt="Fábio Nardoni, Gründer von Sensor Crash Fix"', 'alt="Fábio Nardoni, ustanovitelj Sensor Crash Fix"'],
  ['<p class="about-signature-role">Gründer · Sensor Crash Fix · 3N20</p>', '<p class="about-signature-role">Ustanovitelj · Sensor Crash Fix · 3N20</p>'],
  ...
  ['value="Kontakt — Sensor Crash Fix"', 'value="Kontakt — Sensor Crash Fix"'],
