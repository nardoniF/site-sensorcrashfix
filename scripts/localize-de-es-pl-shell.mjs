...
const REPLACEMENTS = {
  de: [
    ['Protection again after a cracked sensor', 'Harmonie zwischen Tinte und Silizium'],
    ['Loading products...', 'Produkte werden geladen…'],
    ['Loading community…', 'Community wird geladen…'],
    ['Official Store | Sensor Crash Fix — Passcode, Heart Rate & Workout Fix', 'Offizieller Shop | Sensor Crash Fix — Code, Puls & Training'],
    ['Checkout | Sensor Crash Fix — Official Store', 'Kasse | Sensor Crash Fix — Offizieller Shop'],
    ['My Account | Sensor Crash Fix', 'Mein Konto | Sensor Crash Fix'],
    ['Community (beta) | Sensor Crash Fix', 'Community (Beta) | Sensor Crash Fix'],
    ['Where to Buy | Sensor Crash Fix — Passcode & Heart Rate Problems', 'Wo kaufen | Sensor Crash Fix — Code- & Pulsmessprobleme'],
    ...
    ['<span class="badge">Sensor Crash Fix Lens</span>', '<span class="badge">Sensor Crash Fix Linse</span>'],
  ...
  es: [
    ['Protection again after a cracked sensor', 'Paz entre tinta y silicio'],
    ['Loading products...', 'Cargando productos...'],
    ['Loading community…', 'Cargando comunidad…'],
    ['Official Store | Sensor Crash Fix — Passcode, Heart Rate & Workout Fix', 'Tienda Oficial | Sensor Crash Fix — Código, pulso y entrenamiento'],
    ['Checkout | Sensor Crash Fix — Official Store', 'Checkout | Sensor Crash Fix — Tienda Oficial'],
    ['My Account | Sensor Crash Fix', 'Mi cuenta | Sensor Crash Fix'],
    ['Community (beta) | Sensor Crash Fix', 'Comunidad (beta) | Sensor Crash Fix'],
    ['Where to Buy | Sensor Crash Fix — Passcode & Heart Rate Problems', 'Dónde comprar | Sensor Crash Fix — Código y pulso'],
    ...
    ['<span class="badge">Sensor Crash Fix Lens</span>', '<span class="badge">Lente Sensor Crash Fix</span>'],
  ...
  pl: [
    ['Protection again after a cracked sensor', 'Harmonia między tuszem a krzemem'],
    ['Loading products...', 'Ładowanie produktów…'],
    ['Loading community…', 'Ładowanie społeczności…'],
    ['Official Store | Sensor Crash Fix — Passcode, Heart Rate & Workout Fix', 'Oficjalny Sklep | Sensor Crash Fix — Kod, tętno i trening'],
    ['Checkout | Sensor Crash Fix — Official Store', 'Kasa | Sensor Crash Fix — Oficjalny Sklep'],
    ['My Account | Sensor Crash Fix', 'Moje konto | Sensor Crash Fix'],
    ['Community (beta) | Sensor Crash Fix', 'Społeczność (beta) | Sensor Crash Fix'],
    ['Where to Buy | Sensor Crash Fix — Passcode & Heart Rate Problems', 'Gdzie kupić | Sensor Crash Fix — Kod i tętno'],
    ...
    ['<span class="badge">Sensor Crash Fix Lens</span>', '<span class="badge">Soczewka Sensor Crash Fix</span>'],
