...
${worksheets}
  ...
  const DEFAULT_INTL_CURRENCIES = [
    ...
    { code: 'EUR', label: 'Euro (EUR)', langs: ['it', 'de', 'es', 'sl'], countries: ['IT', 'DE', 'ES', 'SI', 'FR', 'NL', 'FI', 'AT', 'BE', 'PT', 'IE'], decimals: 2, active: true },
    { code: 'PLN', label: 'Złoty (PLN)', langs: ['pl'], countries: ['PL'], decimals: 2, active: true },
    { code: 'SEK', label: 'Coroa sueca (SEK)', langs: [], countries: ['SE'], decimals: 0, active: true },
    { code: 'NOK', label: 'Coroa norueguesa (NOK)', langs: [], countries: ['NO'], decimals: 0, active: true }
  ];
  ...
  function collectForm() {
    ...
    return {
      ...
      intlCurrenciesAutoPpp: document.getElementById('admin-intl-auto-ppp')?.checked !== false,      updatedAt: new Date().toISOString()
    };
  }
