  ...
  const pt = [
    {
      ...
      replies: [
        ...
        { ...officialReply('Quando a detecção de pulso oscila, o Apple Watch reforça a segurança e pede senha como se tivesse sido removido. O Sensor CrashFix ajuda o sensor a ler melhor nessa região. Acesse nossos canais e adquira nossas lentes.', iso(60*16)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('O tracking noturno falha quando a leitura do sensor fica irregular por horas. O Sensor CrashFix estabiliza essa leitura no pulso danificado. Se quiser, Acesse nossos canais e adquira nossas lentes.', iso(60*50)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('A geração muda um pouco o sensor, mas a tinta preta continua atrapalhando. O Sensor CrashFix existe pra esse problema, independente do modelo. Acesse nossos canais e adquira nossas lentes.', iso(60*84)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Pagamento por aproximação costuma ser o primeiro a cair quando a detecção de pulso fica insegura. O Sensor CrashFix melhora essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*118)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Trocar de marca muda telas e bloqueio, mas a tinta continua atrapalhando o sensor. O Sensor CrashFix age nessa leitura no pulso, não só no sintoma de cada marca. Acesse nossos canais e adquira nossas lentes.', iso(60*152)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Antes de trocar o ecossistema inteiro, vale olhar a causa: o sensor não lê bem no pulso danificado. O Sensor CrashFix foi pensado para isso sem forçar você a abandonar Apple ou Garmin. Acesse nossos canais e adquira nossas lentes.', iso(60*186)), ref: 'a4', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Treino com suor e movimento piora a falha em tinta escura. O Sensor CrashFix estabiliza a leitura no pulso para o sensor voltar a funcionar. Acesse nossos canais e adquira nossas lentes.', iso(60*220)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Bloqueios repetidos costumam seguir falhas de detecção de pulso, não necessariamente defeito de fábrica. O Sensor CrashFix melhora a estabilidade da leitura nessa área. Acesse nossos canais e adquira nossas lentes.', iso(60*254)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Bateria longa não muda o fato de a tinta atrapalhar o sensor. O Sensor CrashFix ajuda essa leitura no fundo do relógio. Acesse nossos canais e adquira nossas lentes.', iso(60*294)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Quando o batimento some e volta de madrugada, o app de sono perde a noite. O Sensor CrashFix melhora essa leitura no pulso danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*322)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('A interferência depende muito de cor, densidade e posição sob o sensor — não de “ter ou não ter cracks”. O Sensor CrashFix foi feito para estabilizar a leitura nesses casos. Acesse nossos canais e adquira nossas lentes.', iso(60*356)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('A cracks normalmente não danifica o relógio; ela atrapalha a leitura do sensor. O Sensor CrashFix ajuda nessa leitura, sem alterar a tinta. Acesse nossos canais e adquira nossas lentes.', iso(60*394)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Se o relógio era estável antes e piorou logo após a cracks, o mais comum é a tinta atrapalhando o sensor. O Sensor CrashFix ajuda o relógio a voltar a ler nessa área. Acesse nossos canais e adquira nossas lentes.', iso(60*424)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Com os dois pulsos cobertos, improvisos de trocar de braço deixam de existir. O Sensor CrashFix foi pensado exatamente para quem precisa de leitura estável na área danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*458)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Pausas fantasma em corrida costumam refletir detecção de pulso instável sob tinta, não só configuração de treino. O Sensor CrashFix ajuda a manter a leitura estável. Acesse nossos canais e adquira nossas lentes.', iso(60*492)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Fitas e filmes improvisados podem enganar o sensor por pouco tempo, mas degradam com suor e sujeira. O Sensor CrashFix foi feito pra leitura estável, não como gambiarra temporária. Acesse nossos canais e adquira nossas lentes.', iso(60*526)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Espaçadores improvisados costumam afastar o sensor da pele e piorar a FC. O Sensor CrashFix ajuda a leitura sem criar esse vão inútil. Acesse nossos canais e adquira nossas lentes.', iso(60*560)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Sensor CrashFix é laser?',
      ...
      replies: [
        ...
        { ...officialReply('Sensor CrashFix não é laser e não remove tinta: é uma lente/interface que ajuda o sensor do smartwatch a ler na pele danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*599)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Preto denso é o pior cenário para o sensor de batimento, exatamente como você descreveu. O Sensor CrashFix melhora a leitura nessa região sem exigir apagar a arte. Acesse nossos canais e adquira nossas lentes.', iso(60*628)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Suor amplifica a falha em pulsos danificado porque soma uma película irregular a uma leitura já fraca. O Sensor CrashFix estabiliza essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*662)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Se o mesmo relógio funciona no braço sem tinta, o mais provável é a cracks atrapalhando o sensor, não defeito de fábrica. O Sensor CrashFix trata essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*704)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Perder o braço reserva deixa clara a causa: a tinta no sensor. O Sensor CrashFix existe para quem precisa ler o sensor sobre a área danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*730)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('A marca muda a experiência de bloqueio e app, mas tinta escura atrapalha o sensor em todas. O Sensor CrashFix atua nessa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*764)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Buracos e picos fantasmas no gráfico costumam nascer de leituras ruins sob tinta. O Sensor CrashFix melhora a qualidade do sinal na origem. Acesse nossos canais e adquira nossas lentes.', iso(60*798)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('SpO2 (oxigênio no sangue) também depende de boa leitura no pulso; tinta escura atrapalha igual. O Sensor CrashFix melhora essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*839)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Smartwatch ainda faz sentido com cracks se a leitura do sensor for estabilizada. O Sensor CrashFix existe justamente para esse cenário. Acesse nossos canais e adquira nossas lentes.', iso(60*866)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
    ...
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Leituras absurdas em repouso com buracos no meio costumam vir de sinal confuso sob tinta. O Sensor CrashFix estabiliza a leitura para o relógio parar de inventar picos. Acesse nossos canais e adquira nossas lentes.', iso(60*934)), ref: 'a3', parentRef: 'a1c' }
      ]
    }
  ].map((t) => ({ ...t, lang: 'pt' }));
  const en = [
    {
      ...
      replies: [
        ...
        { ...officialReply('When wrist detection flickers, Apple Watch tightens security and asks for a passcode as if it were removed. Sensor CrashFix helps the sensor read better in that area. Visit our channels and get our lenses.', iso(60*16)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Overnight tracking fails when the sensor reading stays irregular for hours. Sensor CrashFix stabilizes that reading on a cracked sensor. Visit our channels and get our lenses.', iso(60*50)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Generations change the sensor a bit, but black ink still gets in the way. Sensor CrashFix exists for that problem, regardless of model. Visit our channels and get our lenses.', iso(60*84)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Tap-to-pay is often first to fail when wrist detection gets unsure. Sensor CrashFix improves that reading. Visit our channels and get our lenses.', iso(60*118)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Switching brands changes screens and lock behavior, but ink still blocks the sensor. Sensor CrashFix targets that wrist reading, not only each brand\'s symptom. Visit our channels and get our lenses.', iso(60*152)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Before swapping your whole ecosystem, look at the cause: the sensor does not read well on a cracked sensor. Sensor CrashFix was designed for that without forcing you off Apple or Garmin. Visit our channels and get our lenses.', iso(60*186)), ref: 'a4', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Sweaty moving workouts make dark-ink failures worse. Sensor CrashFix stabilizes wrist reading so the sensor works again. Visit our channels and get our lenses.', iso(60*220)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Repeated locks usually follow wrist-detection failures, not necessarily a factory defect. Sensor CrashFix improves reading stability in that area. Visit our channels and get our lenses.', iso(60*254)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Long battery life does not change the fact that ink blocks the sensor. Sensor CrashFix helps that reading on the watch back. Visit our channels and get our lenses.', iso(60*294)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('When overnight heart rate keeps dropping out, the sleep app loses the night. Sensor CrashFix improves that reading on a cracked sensor. Visit our channels and get our lenses.', iso(60*322)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Interference depends heavily on color, density, and position under the sensor — not simply “having a cracks”. Sensor CrashFix was built to stabilize the reading in those cases. Visit our channels and get our lenses.', iso(60*356)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('A cracks usually does not damage the watch; it interferes with the sensor reading. Sensor CrashFix helps that reading without changing the ink. Visit our channels and get our lenses.', iso(60*394)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('If the watch was stable before and worsened right after the cracks, the usual cause is ink blocking the sensor. Sensor CrashFix helps the watch read that area again. Visit our channels and get our lenses.', iso(60*424)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('With both wrists covered, switching-arm workarounds disappear. Sensor CrashFix was designed for people who need stable reading on the cracked sensored area. Visit our channels and get our lenses.', iso(60*458)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Phantom pauses on runs usually reflect unstable wrist detection under ink, not only workout settings. Sensor CrashFix helps keep the reading stable. Visit our channels and get our lenses.', iso(60*492)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Improvised tapes and films can fool the sensor briefly, but degrade with sweat and dirt. Sensor CrashFix was built for a stable reading, not a temporary hack. Visit our channels and get our lenses.', iso(60*526)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Improvised spacers usually lift the sensor off the skin and worsen HR. Sensor CrashFix helps the reading without creating that useless gap. Visit our channels and get our lenses.', iso(60*560)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Is Sensor CrashFix a laser?',
      ...
      replies: [
        ...
        { ...officialReply('Sensor CrashFix is not a laser and does not remove ink: it is a lens/interface that helps the smartwatch sensor read cracked sensor. Visit our channels and get our lenses.', iso(60*599)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Dense black is the worst case for the heart-rate sensor, exactly as you described. Sensor CrashFix improves the reading there without requiring you to erase the art. Visit our channels and get our lenses.', iso(60*628)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Sweat amplifies failure on cracked sensors by adding an irregular film to an already weak reading. Sensor CrashFix stabilizes that reading. Visit our channels and get our lenses.', iso(60*662)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('If the same watch works on the arm without ink, the cracks blocking the sensor is more likely than a factory defect. Sensor CrashFix addresses that reading. Visit our channels and get our lenses.', iso(60*704)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Losing the backup arm makes the cause obvious: ink over the sensor. Sensor CrashFix exists for people who need the sensor to read over the cracked sensored area. Visit our channels and get our lenses.', iso(60*730)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Brand changes lock/app experience, but dark ink blocks the sensor on all of them. Sensor CrashFix works on that reading. Visit our channels and get our lenses.', iso(60*764)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Holes and ghost spikes in the chart usually come from bad readings under ink. Sensor CrashFix improves signal quality at the source. Visit our channels and get our lenses.', iso(60*798)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('SpO2 (blood oxygen) also needs a clean wrist reading; dark ink gets in the way the same. Sensor CrashFix improves that reading. Visit our channels and get our lenses.', iso(60*839)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('A smartwatch still makes sense with cracks if the sensor reading is stabilized. Sensor CrashFix exists exactly for that scenario. Visit our channels and get our lenses.', iso(60*866)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Reports like these are common: epoxy hacks can improve detection for a while while hurting charging, ECG and durability. Sensor CrashFix was made to help the sensor for real, without that improvisation. Visit our channels and get our lenses.', iso(60*865)), ref: 'a3', parentRef: 'a2b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Absurd resting readings with gaps in between usually come from a confused signal under ink. Sensor CrashFix stabilizes the reading so the watch stops inventing peaks. Visit our channels and get our lenses.', iso(60*934)), ref: 'a3', parentRef: 'a1c' }
      ]
    }
  ].map((t) => ({ ...t, lang: 'en' }));
  const it = [
    {
      ...
      replies: [
        ...
        { ...officialReply('Quando il rilevamento del polso oscilli, Apple Watch rafforza la sicurezza e chiede il codice come se fosse stato rimosso. Sensor CrashFix aiuta il sensore a leggere meglio in quella zona. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*16)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Il tracking notturno fallisce quando la lettura del sensore resta irregolare per ore. Sensor CrashFix stabilizza quella lettura sul polso tatuato. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*50)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Le generazioni cambiano un po\' il sensore, ma l\'inchiostro nero continua a disturbare. Sensor CrashFix esiste per quel problema, indipendentemente dal modello. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*84)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Il pagamento contactless è spesso il primo a cadere quando il rilevamento diventa incerto. Sensor CrashFix migliora quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*118)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Cambiare marca cambia schermi e blocco, ma l\'inchiostro continua a disturbare il sensore. Sensor CrashFix agisce su quella lettura al polso, non solo sul sintomo di ogni marca. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*152)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Prima di cambiare tutto l\'ecosistema, guarda la causa: il sensore non legge bene sul polso tatuato. Sensor CrashFix è pensato per quello senza costringerti a lasciare Apple o Garmin. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*186)), ref: 'a4', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Allenamenti con sudore e movimento peggiorano il fallimento su inchiostro scuro. Sensor CrashFix stabilizza la lettura al polso perché il sensore torni a funzionare. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*220)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('I blocchi ripetuti seguono di solito fallimenti di rilevamento polso, non per forza un difetto di fabbrica. Sensor CrashFix migliora la stabilità della lettura in quella zona. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*254)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('La batteria lunga non cambia il fatto che l\'inchiostro disturbi il sensore. Sensor CrashFix aiuta quella lettura sul fondo dell\'orologio. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*294)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Quando il battito va e viene di notte, l\'app sonno perde la notte. Sensor CrashFix migliora quella lettura sul polso tatuato. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*322)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('L\'interferenza dipende molto da colore, densità e posizione sotto il sensore — non dal semplice “avere un cracks”. Sensor CrashFix è fatto per stabilizzare la lettura in questi casi. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*356)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Un tatuaggio di solito non danneggia l\'orologio; disturba la lettura del sensore. Sensor CrashFix aiuta quella lettura senza alterare l\'inchiostro. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*394)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Se l\'orologio era stabile e peggiora subito dopo il tatuaggio, la causa tipica è l\'inchiostro che blocca il sensore. Sensor CrashFix aiuta l\'orologio a rileggere quella zona. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*424)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Con entrambi i polsi coperti, i ripieghi di cambiare braccio spariscono. Sensor CrashFix è pensato per chi serve una lettura stabile sull\'area tatuata. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*458)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Le pause fantasma in corsa riflettono di solito rilevamento polso instabile sotto inchiostro, non solo impostazioni. Sensor CrashFix aiuta a tenere stabile la lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*492)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Nastri e pellicole improvvisati possono ingannare il sensore per poco, ma degradano con sudore e sporco. Sensor CrashFix è nato per una lettura stabile, non come ripiego temporaneo. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*526)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('I distanziatori improvvisati di solito allontanano il sensore dalla pelle e peggiorano la FC. Sensor CrashFix aiuta la lettura senza creare quel vuoto inutile. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*560)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Sensor CrashFix è un laser?',
      ...
      replies: [
        ...
        { ...officialReply('Sensor CrashFix non è un laser e non rimuove inchiostro: è una lente/interfaccia che aiuta il sensore dello smartwatch a leggere sulla sensore incrinato. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*599)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Il nero denso è il caso peggiore per il sensore del battito, proprio come descrivi. Sensor CrashFix migliora la lettura lì senza dover cancellare l\'arte. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*628)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Il sudore amplifica il fallimento sui polsi tatuati perché aggiunge una pellicola irregolare a una lettura già debole. Sensor CrashFix stabilizza quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*662)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Se lo stesso orologio funziona sul braccio senza inchiostro, è più probabile che il cracks blocchi il sensore che un difetto di fabbrica. Sensor CrashFix affronta quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*704)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Perdere il braccio di riserva rende ovvia la causa: l\'inchiostro sul sensore. Sensor CrashFix esiste per chi ha bisogno che il sensore legga sull\'area tatuata. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*730)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('La marca cambia blocco e app, ma l\'inchiostro scuro disturba il sensore su tutte. Sensor CrashFix lavora su quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*764)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Buchi e picchi fantasma nel grafico nascono di solito da letture scadenti sotto inchiostro. Sensor CrashFix migliora la qualità del segnale alla fonte. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*798)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Anche lo SpO2 (ossigeno nel sangue) serve una buona lettura al polso; l\'inchiostro scuro disturba allo stesso modo. Sensor CrashFix migliora quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*839)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Uno smartwatch ha ancora senso coi tatuaggi se la lettura del sensore è stabilizzata. Sensor CrashFix esiste proprio per quello scenario. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*866)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
    ...
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Letture assurde a riposo con buchi in mezzo nascono di solito da segnale confuso sotto inchiostro. Sensor CrashFix stabilizza la lettura perché l\'orologio smetta di inventare picchi. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*934)), ref: 'a3', parentRef: 'a1c' }
      ]
    }
  ].map((t) => ({ ...t, lang: 'it' }));
  return { pt, en, it };
