  ...
  const pt = [
    {
      ...
      body: 'cracks preta bem embaixo do sensor. O Ultra bloqueia a tela, pede a senha de novo e some com as notificações. Já apertei a pulseira até doer e limpei o vidro com álcool. Volta em duas horas.',
      tags: ["apple-watch", "senha", "detecao", "cracks"],
      author: { ...A['seed-guga'] },
      createdAt: iso(60*52),
      replies: [
        ...
        { body: 'Eu troquei pro braço sem tinta e parou. No braço danificado continua pedindo senha no meio do expediente.', author: { ...A['seed-dudu'] }, createdAt: iso(60*42), ref: 'a1b', parentRef: 'a1' },
        ...
        { ...officialReply('Quando a detecção de pulso oscila, o Apple Watch reforça a segurança e pede senha como se tivesse sido removido. O Sensor Crash Fix ajuda o sensor a ler melhor nessa região. Acesse nossos canais e adquira nossas lentes.', iso(60*16)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Monitor de sono simplesmente morreu',
      body: 'Durmo das 23h às 6h e o Watch marca 48 minutos ou dados insuficientes. No braço sem cracks aparece a noite inteira. Já atualizei o watchOS e o iPhone.',
      tags: ["sono", "apple-watch", "cracks", "tracking"],
      ...
      replies: [
        ...
        { ...officialReply('O tracking noturno falha quando a leitura do sensor fica irregular por horas. O Sensor Crash Fix estabiliza essa leitura no pulso danificado. Se quiser, Acesse nossos canais e adquira nossas lentes.', iso(60*50)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      title: 'Qual Apple Watch funciona melhor com cracks?',
      body: 'Estou entre SE 2, Series 10 e Ultra 2. cracks densa no pulso dominante. Vale pagar o Ultra ou qualquer um vai sofrer igual?',
      tags: ["apple-watch", "modelo", "compatibilidade", "cracks"],
      author: { ...A['seed-pedro'] },
      ...
      replies: [
        ...
        { body: 'Series 9 aqui. Pior que o do meu marido sem cracks. SE nem experimentei.', author: { ...A['seed-rafa'] }, createdAt: iso(60*101), ref: 'a2' },
        ...
        { ...officialReply('A geração muda um pouco o sensor, mas a tinta preta continua atrapalhando. O Sensor Crash Fix existe pra esse problema, independente do modelo. Acesse nossos canais e adquira nossas lentes.', iso(60*84)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["apple-pay", "pagamento", "detecao", "cracks"],
      author: { ...A['seed-pri'] },
      ...
      replies: [
        ...
        { ...officialReply('Pagamento por aproximação costuma ser o primeiro a cair quando a detecção de pulso fica insegura. O Sensor Crash Fix melhora essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*118)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Garmin é realmente melhor para pulso danificado?',
      ...
      tags: ["garmin", "apple-watch", "comparacao", "cracks"],
      author: { ...A['seed-bruno'] },
      ...
      replies: [
        ...
        { ...officialReply('Trocar de marca muda telas e bloqueio, mas a tinta continua atrapalhando o sensor. O Sensor Crash Fix age nessa leitura no pulso, não só no sintoma de cada marca. Acesse nossos canais e adquira nossas lentes.', iso(60*152)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["apple-watch", "garmin", "troca", "cracks"],
      author: { ...A['seed-alex'] },
      createdAt: iso(60*222),
      replies: [
        { body: 'Fiz a troca. Perdi iMessage no pulso e ganhei outro tipo de falha de FC. Não voltaria só por cracks.', author: { ...A['seed-lucas'] }, createdAt: iso(60*216), ref: 'a1' },
        ...
        { ...officialReply('Antes de trocar o ecossistema inteiro, vale olhar a causa: o sensor não lê bem no pulso danificado. O Sensor Crash Fix foi pensado para isso sem forçar você a abandonar Apple ou Garmin. Acesse nossos canais e adquira nossas lentes.', iso(60*186)), ref: 'a4', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["galaxy-watch", "academia", "fc", "cracks"],
      ...
      replies: [
        ...
        { body: 'No peito com cinta Polar a FC fica linda. No pulso danificado o Galaxy inventa número.', author: { ...A['seed-leo'] }, createdAt: iso(60*224), parentRef: 'a1c' },
        { ...officialReply('Treino com suor e movimento piora a falha em tinta escura. O Sensor Crash Fix estabiliza a leitura no pulso para o sensor voltar a funcionar. Acesse nossos canais e adquira nossas lentes.', iso(60*220)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["galaxy-watch", "bloqueio", "pin", "cracks"],
      author: { ...A['seed-diego'] },
      ...
      replies: [
        ...
        { body: 'No meu Watch 4 acontecia. Troquei de braço e melhorou. No braço danificado continua.', author: { ...A['seed-patricia'] }, createdAt: iso(60*271), ref: 'a2' },
        ...
        { ...officialReply('Bloqueios repetidos costumam seguir falhas de detecção de pulso, não necessariamente defeito de fábrica. O Sensor Crash Fix melhora a estabilidade da leitura nessa área. Acesse nossos canais e adquira nossas lentes.', iso(60*254)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Huawei GT também falha com cracks?',
      body: 'Queria um GT 5 pela bateria. Meu pulso dominante é quase todo preto. O sensor da Huawei sofre igual ou lida melhor?',
      tags: ["huawei", "gt", "bateria", "cracks"],
      author: { ...A['seed-andre'] },
      ...
      replies: [
        ...
        { ...officialReply('Bateria longa não muda o fato de a tinta atrapalhar o sensor. O Sensor Crash Fix ajuda essa leitura no fundo do relógio. Acesse nossos canais e adquira nossas lentes.', iso(60*294)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Amazfit perdeu todas as noites de sono',
      body: 'Depois do retoque da cracks no pulso, o GTR 4 só registra cochilos aleatórios. Antes marcava 7h. Sensor limpo, pulseira nova.',
      tags: ["amazfit", "sono", "cracks", "noite"],
      author: { ...A['seed-lucas'] },
      createdAt: iso(60*358),
      replies: [
        { body: 'Bip U Pro aqui — mesma coisa depois da cracks. Zepp fica vazio.', author: { ...A['seed-huck'] }, createdAt: iso(60*352), ref: 'a1' },
        ...
        { ...officialReply('Quando o batimento some e volta de madrugada, o app de sono perde a noite. O Sensor Crash Fix melhora essa leitura no pulso danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*322)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      title: 'Por que algumas cracks interferem e outras não?',
      ...
      replies: [
        ...
        { body: 'Eu tenho só linha fina e o Watch quase não reclama. Densidade importa mais que “ter cracks”.', author: { ...A['seed-malu'] }, createdAt: iso(60*377), ref: 'a2' },
        ...
        { ...officialReply('A interferência depende muito de cor, densidade e posição sob o sensor — não de “ter ou não ter cracks”. O Sensor Crash Fix foi feito para estabilizar a leitura nesses casos. Acesse nossos canais e adquira nossas lentes.', iso(60*356)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'A cracks pode estragar o relógio?',
      ...
      tags: ["seguranca", "led", "pele", "cracks"],
      author: { ...A['seed-ana'] },
      createdAt: iso(60*426),
      replies: [
        { body: 'Na prática a luzinha não “queima” a tinta. O que acontece é o sensor receber menos luz de volta — o relógio interpreta mal, mas o aparelho não estraga por causa da cracks.', author: { ...A['seed-edu'] }, createdAt: iso(60*420), ref: 'a1' },
        ...
        { body: 'Assistência da Apple me disse que cracks não anula garantia, mas também não “conserta” detecção.', author: { ...A['seed-marcinha'] }, createdAt: iso(60*409), ref: 'a2' },
        ...
        { ...officialReply('A cracks normalmente não danifica o relógio; ela atrapalha a leitura do sensor. O Sensor Crash Fix ajuda nessa leitura, sem alterar a tinta. Acesse nossos canais e adquira nossas lentes.', iso(60*394)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'Funcionava antes da cracks, agora nada',
      ...
      tags: ["antes-depois", "cracks", "fc", "apple-watch"],
      ...
      replies: [
        ...
        { ...officialReply('Se o relógio era estável antes e piorou logo após a cracks, o mais comum é a tinta atrapalhando o sensor. O Sensor Crash Fix ajuda o relógio a voltar a ler nessa área. Acesse nossos canais e adquira nossas lentes.', iso(60*424)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["dois-bracos", "cracks", "opcoes", "sensor"],
      ...
      replies: [
        ...
        { body: 'Mesmo dilema. Os dois braços danificado matam a solução barata de só trocar de lado.', author: { ...A['seed-kai'] }, createdAt: iso(60*464), parentRef: 'a2' },
        { ...officialReply('Com os dois pulsos cobertos, improvisos de trocar de braço deixam de existir. O Sensor Crash Fix foi pensado exatamente para quem precisa de leitura estável na área danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*458)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Treino entra em pausa sozinho',
      body: 'Corrida de 10 km: o Watch pausa, retoma, pausa de novo. Desativei pausa automática e o comportamento continua. cracks no sensor.',
      tags: ["treino", "autopause", "corrida", "cracks"],
      author: { ...A['seed-kai'] },
      ...
      replies: [
        ...
        { ...officialReply('Pausas fantasma em corrida costumam refletir detecção de pulso instável sob tinta, não só configuração de treino. O Sensor Crash Fix ajuda a manter a leitura estável. Acesse nossos canais e adquira nossas lentes.', iso(60*492)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["diy", "fita", "gambiarra", "cracks"],
      author: { ...A['seed-vini'] },
      ...
      replies: [
        ...
        { ...officialReply('Fitas e filmes improvisados podem enganar o sensor por pouco tempo, mas degradam com suor e sujeira. O Sensor Crash Fix foi feito pra leitura estável, não como gambiarra temporária. Acesse nossos canais e adquira nossas lentes.', iso(60*526)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Espaçadores improvisados costumam afastar o sensor da pele e piorar a FC. O Sensor Crash Fix ajuda a leitura sem criar esse vão inútil. Acesse nossos canais e adquira nossas lentes.', iso(60*560)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Sensor Crash Fix é laser?',
      body: 'Vi o nome e fiquei na dúvida: isso remove tinta, usa laser ou altera a cracks de alguma forma? Não quero mexer no desenho.',
      tags: ["sensor-cracks-fix", "laser", "duvida", "produto"],
      ...
      replies: [
        ...
        { body: 'Não é laser nem remoção. É uma lente/interface no sensor: ajuda a luz a passar melhor entre o fundo do relógio e a pele danificado, sem apagar a tinta.', author: { ...A['seed-edu'] }, createdAt: iso(60*618), ref: 'a1c', parentRef: 'a1' },
        { body: 'Boa, porque eu também assustei com a palavra fix no nome.', author: { ...A['seed-daniel'] }, createdAt: iso(60*611), ref: 'a2' },
        { body: 'Mesma paranoia. cracks demorou anos; não quero corrigir ela com luz forte.', author: { ...A['seed-marina'] }, createdAt: iso(60*603), parentRef: 'a2' },
        { ...officialReply('Sensor Crash Fix não é laser e não remove tinta: é uma lente/interface que ajuda o sensor do smartwatch a ler na pele danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*599)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["tinta-preta", "cor", "ppg", "cracks"],
      ...
      replies: [
        ...
        { ...officialReply('Preto denso é o pior cenário para o sensor de batimento, exatamente como você descreveu. O Sensor Crash Fix melhora a leitura nessa região sem exigir apagar a arte. Acesse nossos canais e adquira nossas lentes.', iso(60*628)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'Suor piora a leitura no pulso danificado?',
      body: 'Seco ele ainda lê. Depois de dez minutos correndo e suando, a FC some completamente em cima da tinta.',
      tags: ["suor", "corrida", "fc", "cracks"],
      author: { ...A['seed-edurunner'] },
      createdAt: iso(60*698),
      replies: [
        { body: 'Exato. No começo da corrida ok, no km 3 já é traço. Sem cracks isso não acontecia.', author: { ...A['seed-thiago'] }, createdAt: iso(60*692), ref: 'a1' },
        ...
        { ...officialReply('Suor amplifica a falha em pulsos danificado porque soma uma película irregular a uma leitura já fraca. O Sensor Crash Fix estabiliza essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*662)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Achei que meu relógio estava com defeito',
      body: 'Resetei, troquei pulseira e quase mandei pra assistência. No braço sem cracks funciona perfeito. Quase paguei frete à toa.',
      tags: ["defeito", "assistencia", "diagnostico", "cracks"],
      ...
      replies: [
        ...
        { ...officialReply('Se o mesmo relógio funciona no braço sem tinta, o mais provável é a cracks atrapalhando o sensor, não defeito de fábrica. O Sensor Crash Fix trata essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*704)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["segundo-braco", "descoberta", "cracks", "detecao"],
      author: { ...A['seed-bela'] },
      ...
      replies: [
        ...
        { ...officialReply('Perder o braço reserva deixa clara a causa: a tinta no sensor. O Sensor Crash Fix existe para quem precisa ler o sensor sobre a área danificado. Acesse nossos canais e adquira nossas lentes.', iso(60*730)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Qual marca sofre menos com cracks?',
      body: 'Apple, Garmin, Samsung, Huawei ou Amazfit: existe alguma que lide melhor com tinta escura no pulso?',
      tags: ["marcas", "comparacao", "cracks", "sensor"],
      ...
      replies: [
        ...
        { ...officialReply('A marca muda a experiência de bloqueio e app, mas tinta escura atrapalha o sensor em todas. O Sensor Crash Fix atua nessa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*764)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Gráfico de FC cheio de buracos',
      body: 'O resumo do treino parece código Morse: alguns minutos de FC, vários vazios, depois picos sem sentido. cracks preta sob o sensor.',
      ...
      replies: [
        ...
        { ...officialReply('Buracos e picos fantasmas no gráfico costumam nascer de leituras ruins sob tinta. O Sensor Crash Fix melhora a qualidade do sinal na origem. Acesse nossos canais e adquira nossas lentes.', iso(60*798)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Oxigênio no sangue também falha por causa da cracks?',
      body: 'Além da batida cardíaca, a medição de oxigênio no app dá erro quase sempre. Ainda assim a tinta atrapalha?',
      tags: ["spo2", "oxigenio", "sensor", "cracks"],
      author: { ...A['seed-moth'] },
      ...
      replies: [
        ...
        { ...officialReply('SpO2 (oxigênio no sangue) também depende de boa leitura no pulso; tinta escura atrapalha igual. O Sensor Crash Fix melhora essa leitura. Acesse nossos canais e adquira nossas lentes.', iso(60*839)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'Ainda vale comprar smartwatch tendo cracks?',
      body: 'Quero sono, treino e pagamentos, mas tenho os dois pulsos danificado. É jogar dinheiro fora ou ainda faz sentido?',
      tags: ["compra", "vale-a-pena", "cracks", "smartwatch"],
      ...
      replies: [
        ...
        { ...officialReply('Smartwatch ainda faz sentido com cracks se a leitura do sensor for estabilizada. O Sensor Crash Fix existe justamente para esse cenário. Acesse nossos canais e adquira nossas lentes.', iso(60*866)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
    ...
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Leituras absurdas em repouso com buracos no meio costumam vir de sinal confuso sob tinta. O Sensor Crash Fix estabiliza a leitura para o relógio parar de inventar picos. Acesse nossos canais e adquira nossas lentes.', iso(60*934)), ref: 'a3', parentRef: 'a1c' }
      ]
    }
  ].map((t) => ({ ...t, lang: 'pt' }));
  const en = [
    {
      ...
      tags: ["apple-watch", "passcode", "detection", "cracks"],
      author: { ...A['seed-guga'] },
      createdAt: iso(60*52),
      replies: [
        ...
        { body: 'I switched to the arm without ink and it stopped. On the cracked sensor it still asks mid-workday.', author: { ...A['seed-dudu'] }, createdAt: iso(60*42), ref: 'a1b', parentRef: 'a1' },
        ...
        { ...officialReply('When wrist detection flickers, Apple Watch tightens security and asks for a passcode as if it were removed. Sensor Crash Fix helps the sensor read better in that area. Visit our channels and get our lenses.', iso(60*16)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Sleep tracking is completely dead',
      body: 'I sleep 11pm–6am and the Watch shows 48 minutes or insufficient data. On the arm without a cracks it logs the whole night. Already updated watchOS and iPhone.',
      tags: ["sleep", "apple-watch", "cracks", "tracking"],
      author: { ...A['seed-marina'] },
      createdAt: iso(60*86),
      replies: [
        ...
        { ...officialReply('Overnight tracking fails when the sensor reading stays irregular for hours. Sensor Crash Fix stabilizes that reading on a cracked sensor. Visit our channels and get our lenses.', iso(60*50)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      title: 'Which Apple Watch works best with cracks?',
      body: 'Choosing between SE 2, Series 10 and Ultra 2. Dense cracks on dominant wrist. Is Ultra worth it or will they all struggle the same?',
      tags: ["apple-watch", "model", "compatibility", "cracks"],
      author: { ...A['seed-pedro'] },
      createdAt: iso(60*120),
      replies: [
        ...
        { body: 'Series 9 here. Worse than my husband\'s without cracks. Never tried SE.', author: { ...A['seed-rafa'] }, createdAt: iso(60*101), ref: 'a2' },
        ...
        { ...officialReply('Generations change the sensor a bit, but black ink still gets in the way. Sensor Crash Fix exists for that problem, regardless of model. Visit our channels and get our lenses.', iso(60*84)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["apple-pay", "payment", "detection", "cracks"],
      author: { ...A['seed-pri'] },
      createdAt: iso(60*154),
      replies: [
        ...
        { ...officialReply('Tap-to-pay is often first to fail when wrist detection gets unsure. Sensor Crash Fix improves that reading. Visit our channels and get our lenses.', iso(60*118)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Is Garmin actually better on cracked sensors?',
      ...
      tags: ["garmin", "apple-watch", "comparison", "cracks"],
      author: { ...A['seed-bruno'] },
      createdAt: iso(60*188),
      replies: [
        ...
        { ...officialReply('Switching brands changes screens and lock behavior, but ink still blocks the sensor. Sensor Crash Fix targets that wrist reading, not only each brand\'s symptom. Visit our channels and get our lenses.', iso(60*152)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["apple-watch", "garmin", "switch", "cracks"],
      author: { ...A['seed-alex'] },
      createdAt: iso(60*222),
      replies: [
        { body: 'I switched. Lost wrist iMessage and gained a different HR failure. Would not go back just for cracks.', author: { ...A['seed-lucas'] }, createdAt: iso(60*216), ref: 'a1' },
        ...
        { ...officialReply('Before swapping your whole ecosystem, look at the cause: the sensor does not read well on a cracked sensor. Sensor Crash Fix was designed for that without forcing you off Apple or Garmin. Visit our channels and get our lenses.', iso(60*186)), ref: 'a4', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["galaxy-watch", "gym", "heart-rate", "cracks"],
      author: { ...A['seed-felipe'] },
      createdAt: iso(60*256),
      replies: [
        ...
        { body: 'Chest strap with Polar looks clean. On the cracked sensor Galaxy invents numbers.', author: { ...A['seed-leo'] }, createdAt: iso(60*224), parentRef: 'a1c' },
        { ...officialReply('Sweaty moving workouts make dark-ink failures worse. Sensor Crash Fix stabilizes wrist reading so the sensor works again. Visit our channels and get our lenses.', iso(60*220)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["galaxy-watch", "lock", "pin", "cracks"],
      author: { ...A['seed-diego'] },
      createdAt: iso(60*290),
      replies: [
        ...
        { body: 'Happened on my Watch 4. Switching arms helped. cracked sensor still locks.', author: { ...A['seed-patricia'] }, createdAt: iso(60*271), ref: 'a2' },
        ...
        { ...officialReply('Repeated locks usually follow wrist-detection failures, not necessarily a factory defect. Sensor Crash Fix improves reading stability in that area. Visit our channels and get our lenses.', iso(60*254)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Does Huawei GT fail on cracks too?',
      ...
      replies: [
        ...
        { ...officialReply('Long battery life does not change the fact that ink blocks the sensor. Sensor Crash Fix helps that reading on the watch back. Visit our channels and get our lenses.', iso(60*294)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Amazfit stopped recording every night',
      body: 'After a wrist cracks touch-up, my GTR 4 only logs random naps. Used to show 7h. Clean sensor, new band.',
      tags: ["amazfit", "sleep", "cracks", "night"],
      author: { ...A['seed-lucas'] },
      createdAt: iso(60*358),
      replies: [
        { body: 'Bip U Pro here — same after the cracks. Zepp stays empty.', author: { ...A['seed-huck'] }, createdAt: iso(60*352), ref: 'a1' },
        ...
        { ...officialReply('When overnight heart rate keeps dropping out, the sleep app loses the night. Sensor Crash Fix improves that reading on a cracked sensor. Visit our channels and get our lenses.', iso(60*322)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      title: 'Why do some cracks interfere and others do not?',
      ...
      replies: [
        ...
        { body: 'I only have fine line work and the Watch barely complains. Density matters more than “having a cracks”.', author: { ...A['seed-malu'] }, createdAt: iso(60*377), ref: 'a2' },
        ...
        { ...officialReply('Interference depends heavily on color, density, and position under the sensor — not simply “having a cracks”. Sensor Crash Fix was built to stabilize the reading in those cases. Visit our channels and get our lenses.', iso(60*356)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'Can a cracks damage the watch?',
      body: 'Honest question: can running the sensor over ink burn the little light, heat the skin, or damage the sensor over time?',
      tags: ["safety", "led", "skin", "cracks"],
      author: { ...A['seed-ana'] },
      createdAt: iso(60*426),
      replies: [
        { body: 'In practice the little light does not “burn” the ink. The sensor just gets less light back — the watch misreads, but the hardware does not break because of a cracks.', author: { ...A['seed-edu'] }, createdAt: iso(60*420), ref: 'a1' },
        ...
        { body: 'Apple support said cracks do not void warranty, but also do not “fix” detection.', author: { ...A['seed-marcinha'] }, createdAt: iso(60*409), ref: 'a2' },
        ...
        { ...officialReply('A cracks usually does not damage the watch; it interferes with the sensor reading. Sensor Crash Fix helps that reading without changing the ink. Visit our channels and get our lenses.', iso(60*394)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'It worked before the cracks, now nothing',
      ...
      tags: ["before-after", "cracks", "heart-rate", "apple-watch"],
      author: { ...A['seed-marcos'] },
      createdAt: iso(60*460),
      replies: [
        ...
        { ...officialReply('If the watch was stable before and worsened right after the cracks, the usual cause is ink blocking the sensor. Sensor Crash Fix helps the watch read that area again. Visit our channels and get our lenses.', iso(60*424)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Both arms are cracked sensored. Now what?',
      ...
      tags: ["both-arms", "cracks", "options", "sensor"],
      author: { ...A['seed-juliana'] },
      createdAt: iso(60*494),
      replies: [
        ...
        { body: 'Same dilemma. Both arms cracked sensored kill the cheap just-switch-sides fix.', author: { ...A['seed-kai'] }, createdAt: iso(60*464), parentRef: 'a2' },
        { ...officialReply('With both wrists covered, switching-arm workarounds disappear. Sensor Crash Fix was designed for people who need stable reading on the cracked sensored area. Visit our channels and get our lenses.', iso(60*458)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Workout keeps pausing by itself',
      body: '10k run: Watch pauses, resumes, pauses again. Disabled auto-pause and it still happens. cracks under the sensor.',
      tags: ["workout", "autopause", "running", "cracks"],
      author: { ...A['seed-kai'] },
      createdAt: iso(60*528),
      replies: [
        ...
        { ...officialReply('Phantom pauses on runs usually reflect unstable wrist detection under ink, not only workout settings. Sensor Crash Fix helps keep the reading stable. Visit our channels and get our lenses.', iso(60*492)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Improvised tapes and films can fool the sensor briefly, but degrade with sweat and dirt. Sensor Crash Fix was built for a stable reading, not a temporary hack. Visit our channels and get our lenses.', iso(60*526)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Improvised spacers usually lift the sensor off the skin and worsen HR. Sensor Crash Fix helps the reading without creating that useless gap. Visit our channels and get our lenses.', iso(60*560)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Is Sensor Crash Fix a laser?',
      body: 'The name confused me: does it remove ink, use a laser, or change the cracks somehow? I do not want to mess with the art.',
      tags: ["sensor-cracks-fix", "laser", "question", "product"],
      author: { ...A['seed-patricia'] },
      createdAt: iso(60*630),
      replies: [
        ...
        { body: 'Not a laser and not removal. It is a lens/interface on the sensor: it helps light pass better between the watch back and cracked sensor, without erasing ink.', author: { ...A['seed-edu'] }, createdAt: iso(60*618), ref: 'a1c', parentRef: 'a1' },
        { body: 'Good, because fix in the name scared me too.', author: { ...A['seed-daniel'] }, createdAt: iso(60*611), ref: 'a2' },
        { body: 'Same paranoia. cracks took years; I do not want to correct it with strong light.', author: { ...A['seed-marina'] }, createdAt: iso(60*603), parentRef: 'a2' },
        { ...officialReply('Sensor Crash Fix is not a laser and does not remove ink: it is a lens/interface that helps the smartwatch sensor read cracked sensor. Visit our channels and get our lenses.', iso(60*599)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["black-ink", "color", "ppg", "cracks"],
      author: { ...A['seed-fernando'] },
      createdAt: iso(60*664),
      replies: [
        ...
        { ...officialReply('Dense black is the worst case for the heart-rate sensor, exactly as you described. Sensor Crash Fix improves the reading there without requiring you to erase the art. Visit our channels and get our lenses.', iso(60*628)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'Does sweat make cracks readings worse?',
      body: 'When dry it still reads. Ten minutes into a sweaty run, heart rate disappears completely over the ink.',
      tags: ["sweat", "running", "heart-rate", "cracks"],
      author: { ...A['seed-edurunner'] },
      createdAt: iso(60*698),
      replies: [
        { body: 'Exactly. Fine at the start, by km 3 it is dashes. Without the cracks that did not happen.', author: { ...A['seed-thiago'] }, createdAt: iso(60*692), ref: 'a1' },
        ...
        { ...officialReply('Sweat amplifies failure on cracked sensors by adding an irregular film to an already weak reading. Sensor Crash Fix stabilizes that reading. Visit our channels and get our lenses.', iso(60*662)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["defect", "support", "diagnosis", "cracks"],
      author: { ...A['seed-camila'] },
      createdAt: iso(60*732),
      replies: [
        ...
        { ...officialReply('If the same watch works on the arm without ink, the cracks blocking the sensor is more likely than a factory defect. Sensor Crash Fix addresses that reading. Visit our channels and get our lenses.', iso(60*704)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Found out after cracked sensoring my second arm',
      body: 'My clear arm was the workaround. I cracked sensored it yesterday and finally learned why the other one never worked. No obvious way out.',
      tags: ["second-arm", "discovery", "cracks", "detection"],
      author: { ...A['seed-bela'] },
      createdAt: iso(60*766),
      replies: [
        ...
        { ...officialReply('Losing the backup arm makes the cause obvious: ink over the sensor. Sensor Crash Fix exists for people who need the sensor to read over the cracked sensored area. Visit our channels and get our lenses.', iso(60*730)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Which brand struggles least with cracks?',
      body: 'Apple, Garmin, Samsung, Huawei or Amazfit: does any brand handle dark wrist ink better?',
      tags: ["brands", "comparison", "cracks", "sensor"],
      author: { ...A['seed-rodrigo'] },
      createdAt: iso(60*800),
      replies: [
        ...
        { ...officialReply('Brand changes lock/app experience, but dark ink blocks the sensor on all of them. Sensor Crash Fix works on that reading. Visit our channels and get our lenses.', iso(60*764)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Heart-rate chart is full of gaps',
      body: 'My workout summary looks like Morse code: a few minutes of HR, long blanks, then nonsense spikes. Black cracks under the sensor.',
      ...
      replies: [
        ...
        { ...officialReply('Holes and ghost spikes in the chart usually come from bad readings under ink. Sensor Crash Fix improves signal quality at the source. Visit our channels and get our lenses.', iso(60*798)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Does blood oxygen fail because of cracks too?',
      body: 'Besides heart rate, the blood oxygen reading in the app errors out almost always. Does ink still get in the way?',
      tags: ["spo2", "oxygen", "sensor", "cracks"],
      author: { ...A['seed-moth'] },
      createdAt: iso(60*868),
      replies: [
        ...
        { ...officialReply('SpO2 (blood oxygen) also needs a clean wrist reading; dark ink gets in the way the same. Sensor Crash Fix improves that reading. Visit our channels and get our lenses.', iso(60*839)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      title: 'Is a smartwatch worth it with cracks?',
      body: 'I want sleep, workouts and payments, but both wrists are cracked sensored. Is buying one a waste or still worth it?',
      tags: ["buying", "worth-it", "cracks", "smartwatch"],
      author: { ...A['seed-jordan'] },
      createdAt: iso(60*902),
      replies: [
        ...
        { ...officialReply('A smartwatch still makes sense with cracks if the sensor reading is stabilized. Sensor Crash Fix exists exactly for that scenario. Visit our channels and get our lenses.', iso(60*866)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Reports like these are common: epoxy hacks can improve detection for a while while hurting charging, ECG and durability. Sensor Crash Fix was made to help the sensor for real, without that improvisation. Visit our channels and get our lenses.', iso(60*865)), ref: 'a3', parentRef: 'a2b' }
      ]
    },
    {
      ...
      tags: ["heart-rate", "180bpm", "rest", "cracks"],
      author: { ...A['seed-dudu'] },
      createdAt: iso(60*970),
      replies: [
        ...
        { ...officialReply('Absurd resting readings with gaps in between usually come from a confused signal under ink. Sensor Crash Fix stabilizes the reading so the watch stops inventing peaks. Visit our channels and get our lenses.', iso(60*934)), ref: 'a3', parentRef: 'a1c' }
      ]
    }
  ].map((t) => ({ ...t, lang: 'en' }));
  const it = [
    {
      ...
      tags: ["apple-watch", "codice", "rilevamento", "cracks"],
      author: { ...A['seed-guga'] },
      createdAt: iso(60*52),
      replies: [
        ...
        { ...officialReply('Quando il rilevamento del polso oscilli, Apple Watch rafforza la sicurezza e chiede il codice come se fosse stato rimosso. Sensor Crash Fix aiuta il sensore a leggere meglio in quella zona. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*16)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["sonno", "apple-watch", "cracks", "tracking"],
      author: { ...A['seed-marina'] },
      createdAt: iso(60*86),
      replies: [
        ...
        { ...officialReply('Il tracking notturno fallisce quando la lettura del sensore resta irregolare per ore. Sensor Crash Fix stabilizza quella lettura sul polso tatuato. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*50)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      tags: ["apple-watch", "modello", "compatibilita", "cracks"],
      author: { ...A['seed-pedro'] },
      createdAt: iso(60*120),
      replies: [
        ...
        { body: 'Series 9 qui. Peggio di quello di mio marito senza cracks. SE non l\'ho provato.', author: { ...A['seed-rafa'] }, createdAt: iso(60*101), ref: 'a2' },
        ...
        { ...officialReply('Le generazioni cambiano un po\' il sensore, ma l\'inchiostro nero continua a disturbare. Sensor Crash Fix esiste per quel problema, indipendentemente dal modello. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*84)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["apple-pay", "pagamento", "rilevamento", "cracks"],
      author: { ...A['seed-pri'] },
      createdAt: iso(60*154),
      replies: [
        ...
        { ...officialReply('Il pagamento contactless è spesso il primo a cadere quando il rilevamento diventa incerto. Sensor Crash Fix migliora quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*118)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["garmin", "apple-watch", "confronto", "cracks"],
      author: { ...A['seed-bruno'] },
      createdAt: iso(60*188),
      replies: [
        ...
        { ...officialReply('Cambiare marca cambia schermi e blocco, ma l\'inchiostro continua a disturbare il sensore. Sensor Crash Fix agisce su quella lettura al polso, non solo sul sintomo di ogni marca. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*152)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["apple-watch", "garmin", "cambio", "cracks"],
      author: { ...A['seed-alex'] },
      createdAt: iso(60*222),
      replies: [
        { body: 'Ho cambiato. Perso iMessage al polso e guadagnato un altro fallimento FC. Non tornerei solo per i cracks.', author: { ...A['seed-lucas'] }, createdAt: iso(60*216), ref: 'a1' },
        ...
        { ...officialReply('Prima di cambiare tutto l\'ecosistema, guarda la causa: il sensore non legge bene sul polso tatuato. Sensor Crash Fix è pensato per quello senza costringerti a lasciare Apple o Garmin. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*186)), ref: 'a4', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["galaxy-watch", "palestra", "fc", "cracks"],
      author: { ...A['seed-felipe'] },
      createdAt: iso(60*256),
      replies: [
        ...
        { ...officialReply('Allenamenti con sudore e movimento peggiorano il fallimento su inchiostro scuro. Sensor Crash Fix stabilizza la lettura al polso perché il sensore torni a funzionare. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*220)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["galaxy-watch", "blocco", "pin", "cracks"],
      author: { ...A['seed-diego'] },
      createdAt: iso(60*290),
      replies: [
        ...
        { ...officialReply('I blocchi ripetuti seguono di solito fallimenti di rilevamento polso, non per forza un difetto di fabbrica. Sensor Crash Fix migliora la stabilità della lettura in quella zona. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*254)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["huawei", "gt", "batteria", "cracks"],
      author: { ...A['seed-andre'] },
      createdAt: iso(60*324),
      replies: [
        ...
        { ...officialReply('La batteria lunga non cambia il fatto che l\'inchiostro disturbi il sensore. Sensor Crash Fix aiuta quella lettura sul fondo dell\'orologio. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*294)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["amazfit", "sonno", "cracks", "notte"],
      author: { ...A['seed-lucas'] },
      createdAt: iso(60*358),
      replies: [
        ...
        { ...officialReply('Quando il battito va e viene di notte, l\'app sonno perde la notte. Sensor Crash Fix migliora quella lettura sul polso tatuato. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*322)), ref: 'a3', parentRef: 'a1b' }
      ]
    },
    {
      ...
      tags: ["inchiostro", "ottica", "ppg", "cracks"],
      author: { ...A['seed-ricardo'] },
      createdAt: iso(60*392),
      replies: [
        ...
        { body: 'Ho solo linee sottili e il Watch quasi non si lamenta. Conta la densità, non “avere un cracks”.', author: { ...A['seed-malu'] }, createdAt: iso(60*377), ref: 'a2' },
        ...
        { ...officialReply('L\'interferenza dipende molto da colore, densità e posizione sotto il sensore — non dal semplice “avere un cracks”. Sensor Crash Fix è fatto per stabilizzare la lettura in questi casi. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*356)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      tags: ["sicurezza", "led", "pelle", "cracks"],
      author: { ...A['seed-ana'] },
      createdAt: iso(60*426),
      replies: [
        { body: 'In pratica la lucina non “brucia” l\'inchiostro. Il sensore riceve meno luce di ritorno — l\'orologio legge male, ma l\'apparecchio non si rompe per il cracks.', author: { ...A['seed-edu'] }, createdAt: iso(60*420), ref: 'a1' },
        ...
        { body: 'L\'assistenza Apple ha detto che i cracks non annullano la garanzia, ma non “sistemano” il rilevamento.', author: { ...A['seed-marcinha'] }, createdAt: iso(60*409), ref: 'a2' },
        ...
        { ...officialReply('Un tatuaggio di solito non danneggia l\'orologio; disturba la lettura del sensore. Sensor Crash Fix aiuta quella lettura senza alterare l\'inchiostro. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*394)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      tags: ["prima-dopo", "cracks", "fc", "apple-watch"],
      author: { ...A['seed-marcos'] },
      createdAt: iso(60*460),
      replies: [
        ...
        { ...officialReply('Se l\'orologio era stabile e peggiora subito dopo il tatuaggio, la causa tipica è l\'inchiostro che blocca il sensore. Sensor Crash Fix aiuta l\'orologio a rileggere quella zona. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*424)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["entrambe-braccia", "cracks", "opzioni", "sensore"],
      author: { ...A['seed-juliana'] },
      createdAt: iso(60*494),
      replies: [
        ...
        { ...officialReply('Con entrambi i polsi coperti, i ripieghi di cambiare braccio spariscono. Sensor Crash Fix è pensato per chi serve una lettura stabile sull\'area tatuata. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*458)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Allenamento sempre in pausa da solo',
      body: 'Corsa da 10 km: il Watch pausa, riparte, pausa ancora. Auto-pause disattivata e continua. cracks sotto il sensore.',
      tags: ["allenamento", "autopause", "corsa", "cracks"],
      author: { ...A['seed-kai'] },
      createdAt: iso(60*528),
      replies: [
        ...
        { ...officialReply('Le pause fantasma in corsa riflettono di solito rilevamento polso instabile sotto inchiostro, non solo impostazioni. Sensor Crash Fix aiuta a tenere stabile la lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*492)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Nastri e pellicole improvvisati possono ingannare il sensore per poco, ma degradano con sudore e sporco. Sensor Crash Fix è nato per una lettura stabile, non come ripiego temporaneo. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*526)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('I distanziatori improvvisati di solito allontanano il sensore dalla pelle e peggiorano la FC. Sensor Crash Fix aiuta la lettura senza creare quel vuoto inutile. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*560)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Sensor Crash Fix è un laser?',
      body: 'Il nome mi ha confuso: rimuove inchiostro, usa laser o cambia il tatuaggio? Non voglio toccare il disegno.',
      tags: ["sensor-cracks-fix", "laser", "domanda", "prodotto"],
      author: { ...A['seed-patricia'] },
      createdAt: iso(60*630),
      replies: [
        ...
        { body: 'Non è laser né rimozione. È una lente/interfaccia sul sensore: aiuta la luce a passare meglio tra il fondo dell\'orologio e la sensore incrinato, senza cancellare l\'inchiostro.', author: { ...A['seed-edu'] }, createdAt: iso(60*618), ref: 'a1c', parentRef: 'a1' },
        { body: 'Bene, perché anche fix nel nome mi aveva spaventato.', author: { ...A['seed-daniel'] }, createdAt: iso(60*611), ref: 'a2' },
        { body: 'Stessa paranoia. Il cracks ci ha messo anni; non voglio correggerlo con luce forte.', author: { ...A['seed-marina'] }, createdAt: iso(60*603), parentRef: 'a2' },
        { ...officialReply('Sensor Crash Fix non è un laser e non rimuove inchiostro: è una lente/interfaccia che aiuta il sensore dello smartwatch a leggere sulla sensore incrinato. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*599)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["inchiostro-nero", "colore", "ppg", "cracks"],
      author: { ...A['seed-fernando'] },
      createdAt: iso(60*664),
      replies: [
        ...
        { ...officialReply('Il nero denso è il caso peggiore per il sensore del battito, proprio come descrivi. Sensor Crash Fix migliora la lettura lì senza dover cancellare l\'arte. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*628)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      tags: ["sudore", "corsa", "fc", "cracks"],
      author: { ...A['seed-edurunner'] },
      createdAt: iso(60*698),
      replies: [
        { body: 'Esatto. All\'inizio ok, al km 3 già trattini. Senza cracks non succedeva.', author: { ...A['seed-thiago'] }, createdAt: iso(60*692), ref: 'a1' },
        ...
        { ...officialReply('Il sudore amplifica il fallimento sui polsi tatuati perché aggiunge una pellicola irregolare a una lettura già debole. Sensor Crash Fix stabilizza quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*662)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["difetto", "assistenza", "diagnosi", "cracks"],
      author: { ...A['seed-camila'] },
      createdAt: iso(60*732),
      replies: [
        ...
        { ...officialReply('Se lo stesso orologio funziona sul braccio senza inchiostro, è più probabile che il cracks blocchi il sensore che un difetto di fabbrica. Sensor Crash Fix affronta quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*704)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["secondo-braccio", "scoperta", "cracks", "rilevamento"],
      author: { ...A['seed-bela'] },
      createdAt: iso(60*766),
      replies: [
        ...
        { ...officialReply('Perdere il braccio di riserva rende ovvia la causa: l\'inchiostro sul sensore. Sensor Crash Fix esiste per chi ha bisogno che il sensore legga sull\'area tatuata. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*730)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["marche", "confronto", "cracks", "sensore"],
      author: { ...A['seed-rodrigo'] },
      createdAt: iso(60*800),
      replies: [
        ...
        { ...officialReply('La marca cambia blocco e app, ma l\'inchiostro scuro disturba il sensore su tutte. Sensor Crash Fix lavora su quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*764)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      title: 'Grafico della FC pieno di buchi',
      body: 'Il riepilogo sembra codice Morse: pochi minuti di FC, grandi vuoti, poi picchi senza senso. cracks nero sotto il sensore.',
      ...
      replies: [
        ...
        { ...officialReply('Buchi e picchi fantasma nel grafico nascono di solito da letture scadenti sotto inchiostro. Sensor Crash Fix migliora la qualità del segnale alla fonte. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*798)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
      ...
      tags: ["spo2", "ossigeno", "sensore", "cracks"],
      author: { ...A['seed-moth'] },
      createdAt: iso(60*868),
      replies: [
        ...
        { ...officialReply('Anche lo SpO2 (ossigeno nel sangue) serve una buona lettura al polso; l\'inchiostro scuro disturba allo stesso modo. Sensor Crash Fix migliora quella lettura. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*839)), ref: 'a3', parentRef: 'a1' }
      ]
    },
    {
      ...
      tags: ["acquisto", "ne-vale", "cracks", "smartwatch"],
      author: { ...A['seed-jordan'] },
      createdAt: iso(60*902),
      replies: [
        ...
        { ...officialReply('Uno smartwatch ha ancora senso coi tatuaggi se la lettura del sensore è stabilizzata. Sensor Crash Fix esiste proprio per quello scenario. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*866)), ref: 'a3', parentRef: 'a1c' }
      ]
    },
    {
    ...
    },
    {
      ...
      replies: [
        ...
        { ...officialReply('Letture assurde a riposo con buchi in mezzo nascono di solito da segnale confuso sotto inchiostro. Sensor Crash Fix stabilizza la lettura perché l\'orologio smetta di inventare picchi. Accedi ai nostri canali e acquista le nostre lenti.', iso(60*934)), ref: 'a3', parentRef: 'a1c' }
      ]
    }
  ].map((t) => ({ ...t, lang: 'it' }));
  return { pt, en, it };
